...
function ProductPage() {
  ...
  const compatibilityMap = {
    "cpu": ["motherboard", "gpu", "ram", "storage", "power supply", "case"],
    "motherboard": ["cpu", "ram", "gpu", "storage", "power supply", "case"],
    "gpu": ["cpu", "motherboard", "ram", "power supply", "case"],
    "ram": ["cpu", "motherboard", "storage", "power supply", "case"],
    "storage": ["cpu", "motherboard", "ram", "power supply", "case"],
    "power supply": ["cpu", "motherboard", "gpu", "ram", "storage", "case"],
    "case": ["cpu", "motherboard", "gpu", "ram", "storage", "power supply"],
  };
  ...
  return (
    ...
    <div className="bottom-section">
      ...
      <div className="action-buttons">
            ...
            <button className="cancel-item" onClick={() => navigate("/pc-parts", { state: { selectedCategory: previousCategory } })}>
              Cancel Item
            </button>
